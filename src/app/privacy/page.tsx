  ...
  return (
    <LegalDocument title="プライバシーポリシー" current="privacy">
      ...
      <LegalSection id="data" title="3. 取得する情報">
        ...
        <LegalList
          items={[
            ...
            "利用者がアップロードした商品画像（オブジェクトストレージ上のファイルと、ボードデータ内の参照URL）",
          ]}
        />
      ...
      <LegalSection id="avatar" title="5. プロフィール画像の取扱い">
        ...
        <LegalList
          items={[
            ...
            "利用者がアップロードしたプロフィール画像は、正方形にトリミングしたうえで本サービスが利用するオブジェクトストレージに保存し、プロフィールデータにはその参照URLを保持します。",
      ...
      <LegalSection id="public" title="6. 公開投稿（ボード）の取扱い">
        ...
        <LegalList
          items={[
            ...
            "利用者がアップロードした商品画像は、本サービスが利用するオブジェクトストレージに保存し、ボードデータにはその参照URLを保持します。外部サイトの画像URLを指定した場合は、そのURLを参照します。",
      ...
      <LegalSection id="third-parties" title="7. 外部サービスへの提供">
        ...
        <LegalList
          items={[
            "認証・データベース・オブジェクトストレージ: Supabase（Supabase Auth、PostgreSQL、Storage）",
            "ホスティング: Vercel",
