  ...
  return (
    <LegalDocument title="プライバシーポリシー" current="privacy">
      ...
      <LegalSection id="rights" title="11. 開示・訂正・削除等">
        ...
        />
        <p>
          本ポリシー制定時点では、アカウントそのものを画面上から削除する機能はありません。アカウントの削除、保有個人データの開示・訂正・利用停止等を希望する場合は、第2条の連絡先までご請求ください。ご本人確認ができる場合に限り、法令に従い対応します。請求者がご本人であることが確認できないときは、対応をお断りすることがあります。
        </p>
      </LegalSection>
