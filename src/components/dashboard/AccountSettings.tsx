      ...
      >
        <div className="relative shrink-0">
          ...
          <button
            ...
            className="relative h-20 w-20 rounded-md text-sm font-medium text-stone-600 transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-400 focus-visible:ring-offset-2"
            aria-label="プロフィール画像を変更"
          >
            <span className="flex h-full w-full items-center justify-center overflow-hidden rounded-md bg-stone-200 ring-1 ring-stone-200/80">
              {avatarUrl ? (
          ...
          {avatarUrl && (
            <button
              ...
              disabled={saving}
              className="absolute -right-1.5 -top-1.5 flex h-6 w-6 items-center justify-center rounded-md bg-white text-stone-400 shadow-sm ring-1 ring-stone-200 hover:text-red-500"
